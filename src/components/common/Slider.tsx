    ...
    <div className="">
      ...
      >
        {items.map((item: ISliderItem, index: number) => {
          return (
            <div key={item.name} className="carousel-slide h-[220px] lg:h-[700px]">
              <div className="carousel-description absolute left-auto right-auto mb-10 bottom-0 lg:bottom-1/3 text-left w-full lg:container px-4 md:px-10">
